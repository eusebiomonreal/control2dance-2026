...
export default function FeaturedRelease() {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#06070e] via-[#020308] to-[#06070e]">
      <section className="max-w-screen-2xl mx-auto px-6 pb-8 pt-24 md:px-8 md:pb-16 md:pt-32 relative">
        {/* Badge flotante */}
        ...
        >
          ...
          {product.image && (
            <div 
              className="absolute inset-0 opacity-20 blur-3xl scale-150 transition-transform duration-700 overflow-hidden"
              style={{ 
          ...
          <div className="relative z-10 p-4 pt-8 md:p-16 md:pt-24 lg:p-20 lg:pt-28 flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-center justify-center">
            ...
            {/* Panel Derecho: Info del disco */}
            <div className="w-full md:w-3/5 relative z-20 text-center md:text-left space-y-4 md:space-y-6">
              {/* Catalog number */}
              ...
              {/* Nombre y artista */}
              <div>
                <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tight leading-none mb-6 md:mb-10">
                  {product.name}
                </h2>
                <p className="text-lg sm:text-lg md:text-xl lg:text-2xl text-zinc-400 font-medium mb-4 md:mb-6">
                  {product.brand}
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3 md:gap-4 w-full md:w-auto md:flex-row justify-center md:justify-start pt-4 md:pt-6">
                ...
                >
                  ...
                  Añadir al carrito
                  <span className="text-white/70 text-base">€{product.price.toFixed(2)}</span>
                </button>
